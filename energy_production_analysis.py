...
# Cleaning DataFrame:
# Checking for: missing data and duplicated values.
...
# Filtering the countries, range and sources
# .tail() specifies the period to return (2010-2020)
...
# Getting the mean
# Same structure from the previous function
...
# Comparison of electricity production among countries (line plot)
